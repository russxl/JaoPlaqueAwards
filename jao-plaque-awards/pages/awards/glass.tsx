        ...
        <div className={STYLE_VARIANTS.container.default}>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Crystal Clear Quality</h3>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Custom Designs</h3>
              <p className="mt-2 text-base text-gray-500">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Premium Finish</h3>
              <p className="mt-2 text-base text-gray-500">
